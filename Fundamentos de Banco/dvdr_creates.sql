...
ALTER TABLE  dbo.customer
    ADD CONSTRAINT customer_address_id_fkey FOREIGN KEY (address_id) REFERENCES dbo.address(address_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.film_actor
    ADD CONSTRAINT film_actor_actor_id_fkey FOREIGN KEY (actor_id) REFERENCES dbo.actor(actor_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.film_actor
    ADD CONSTRAINT film_actor_film_id_fkey FOREIGN KEY (film_id) REFERENCES dbo.film(film_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.film_category
    ADD CONSTRAINT film_category_category_id_fkey FOREIGN KEY (category_id) REFERENCES dbo.category(category_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.film_category
    ADD CONSTRAINT film_category_film_id_fkey FOREIGN KEY (film_id) REFERENCES dbo.film(film_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.film
    ADD CONSTRAINT film_language_id_fkey FOREIGN KEY (language_id) REFERENCES dbo.language(language_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE  dbo.inventory
    ADD CONSTRAINT inventory_film_id_fkey FOREIGN KEY (film_id) REFERENCES dbo.film(film_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.payment
    ADD CONSTRAINT payment_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES dbo.customer(customer_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.payment
    ADD CONSTRAINT payment_rental_id_fkey FOREIGN KEY (rental_id) REFERENCES dbo.rental(rental_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
...
ALTER TABLE  dbo.rental
    ADD CONSTRAINT rental_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES dbo.customer(customer_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
GO
ALTER TABLE  dbo.rental
    ADD CONSTRAINT rental_inventory_id_fkey FOREIGN KEY (inventory_id) REFERENCES dbo.inventory(inventory_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.rental
    ADD CONSTRAINT rental_staff_id_key FOREIGN KEY (staff_id) REFERENCES dbo.staff(staff_id);

ALTER TABLE  dbo.staff
    ADD CONSTRAINT staff_address_id_fkey FOREIGN KEY (address_id) REFERENCES dbo.address(address_id) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE  dbo.store
    ADD CONSTRAINT store_address_id_fkey FOREIGN KEY (address_id) REFERENCES dbo.address(address_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
